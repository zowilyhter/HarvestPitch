...
const contractABI = require("../artifacts/contracts/Harvestpitch.sol/Harvestpitch.json").abi;

program
    .name("harvestpitch-cli")
    .description("CLI tool for Harvestpitch smart contract")
    .version("1.0.0");
