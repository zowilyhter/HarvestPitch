 ...
 * This file demonstrates how to integrate Harvestpitch with a web frontend
 */

// For React/Vue/Angular applications
export class HarvestpitchClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new HarvestpitchClient(provider, contractAddress);
